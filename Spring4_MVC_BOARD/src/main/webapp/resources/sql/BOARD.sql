...
CREATE TABLE BOARD(
	...
	BOARD_FILE			VARCHAR2(50),	-- 첨부될 파일 명(년도붙는거)
	BOARD_ORIGINAL		VARCHAR2(50),	--첨부 파일 명(파일명)
...
insert into board (BOARD_NUM, BOARD_SUBJECT, BOARD_NAME, BOARD_RE_REF) values (3, '샛째', 'admin', 3);

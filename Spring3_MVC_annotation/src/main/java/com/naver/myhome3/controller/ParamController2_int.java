...
public class ParamController2_int{
	...
	// required=false로 400오류는 발생하지 않지만 넘어온 값이 null이라 이것을 기본형으로 int형으로 변환하면서 500 오류 발생
	...
	/* 위 예제에서 400번 오류는 없어졌지만 500오류 발생합니다.
	...
	public String param4(@RequestParam(value = "age2",
									   defaultValue = "10",
									   required = false
									   ) int age,
						  Model model) {
